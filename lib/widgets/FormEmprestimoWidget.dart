            ...
            children: [
              ...
              Consumer<BibliotecaProvider>(
                builder: (context, provider, child) {
                  final usuariosAtivos = provider.usuarios
                      .where((u) => u.ativo)
                      .toList();
              ...
              Consumer<BibliotecaProvider>(
                builder: (context, provider, child) {
                  final livrosDisponiveis = provider.livros
              ...
              if (_usuarioSelecionado != null && _livroSelecionado != null) ...[
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('📅 Devolução: ${_formatDate(_dataPrevistaDevolucao)}'),
                      Text('⏰ Prazo: ${_dataPrevistaDevolucao.difference(DateTime.now()).inDays} dias'),
                    ],
                  ),
                ),
                const SizedBox(height: 16),
